...
public class ListTest : IClassFixture<TestInput>
{
    ...
    public void AlternatingList1()
    {
        ...
        Root expected = Token.Root([
            ...
            Token.UL([
                Token.LI([Token.Phrase("ligne 2",3)],2),
            ],1),
            Token.OL([
                Token.LI([Token.Phrase("ligne 3",3)],2),
            ],1),
            Token.UL([
                Token.LI([Token.Phrase("ligne 4",3)],2),
            ],2-1),
        ]);
    ...
    [Fact]
    [Description("Test task list in OL")]
    public void TaskInOl3()
    {
        // Arrange 
        string text = Get("TaskListInOl3.md");
        ...
        Root expected = Token.Root([
            ...
            Token.UL([
                Token.CheckBox([Token.Phrase("Should be a task [ ] Should not be a task",3)],2,false),
                Token.UL([
                    Token.LI([Token.Phrase("Sub list",4)],3)
                ],2),
            ],1),
        ]);
    ...
    public void ListIndent2()
    {
        ...
        Root expected = Token.Root([
            Token.UL([
                ...
                Token.LI([Token.Phrase("element 2",3)],2),
                Token.UL([
                    Token.LI([Token.Phrase("nested 1",4)],3),
                ],2),
                Token.OL([
                    Token.LI([Token.Phrase("nested OL",4)],3),
                ],2),
